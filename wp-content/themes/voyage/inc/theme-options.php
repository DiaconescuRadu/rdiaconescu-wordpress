...
<?php	} ?>
		<p><a class="btn btn-primary" href="<?php _e('http://www.xinthemes.com/documentation/','voyage'); ?>" target="_blank"><strong><?php _e('Documentation','voyage'); ?></strong></a>&nbsp;&nbsp;
		<a class="btn btn-warning" href="<?php _e('http://www.xinthemes.com/voyage-change-log/','voyage'); ?>" target="_blank"><strong><?php _e('Change Log','voyage'); ?></strong></a>&nbsp;&nbsp;
		<a class="btn btn-success" href="<?php _e('http://www.xinthemes.com/support/','voyage'); ?>" target="_blank"><strong><?php _e('Support Forum','voyage'); ?></strong></a>&nbsp;&nbsp;
		<a class="btn btn-info" href="<?php _e('http://www.xinthemes.com/donate/','voyage'); ?>" target="_blank"><strong><?php _e('Donate','voyage'); ?></strong></a></p>
...
<?php
			...
			voyage_option_display( $theme_options['grid_column'], $options );
			voyage_option_display( $theme_options['grid_style'], $options );
			voyage_option_display( $theme_options['mobile_style'], $options );
?>									
			<hr>
			...
			<div class="grid_2">
				<p><input id="voyage_theme_options[blog_layout]_1" name="voyage_theme_options[blog_layout]" type="radio" value="1" <?php checked( '1', $options['blog_layout'] ); ?> />
			...
			<div class="grid_2">
				<p><input id="voyage_theme_options[blog_layout]_2" name="voyage_theme_options[blog_layout]" type="radio" value="2" <?php checked( '2', $options['blog_layout'] ); ?> />
			...
			<div class="grid_2">
				<p><input id="voyage_theme_options[blog_layout]_3" name="voyage_theme_options[blog_layout]" type="radio" value="3" <?php checked( '3', $options['blog_layout'] ); ?> />
			...
			<div class="grid_9">
				...
				<input id="voyage_theme_options[column_home5]" name="voyage_theme_options[column_home5]" type="text" size="4" value="<?php echo esc_attr($options['column_home5']); ?>" />
				<label class="description"><?php _e('Columns', 'voyage'); ?></label></p>
...
?>
			<div class="voyage-pane clearfix"><div class="grid_12">
<?php
			voyage_option_display( $theme_options['headerstyle'], $options );
			voyage_option_display( $theme_options['fixed_menu'], $options );
			voyage_option_display( $theme_options['resp_menu'], $options );
...
?>
			<div class="voyage-pane clearfix"><div class="grid_12">
<?php
			voyage_option_display( $theme_options['titlebar'], $options );
?>
...
<?php
			...
			voyage_option_display( $theme_options['datestyle'], $options );
			voyage_option_display( $theme_options['pp_commoff'], $options );
			voyage_option_display( $theme_options['pagecommoff'], $options );
			voyage_option_display( $theme_options['postcommoff'], $options );
...
?>
			...
			<div class="grid_9">
				<p><input id="voyage_theme_options[sociallink_top]" name="voyage_theme_options[sociallink_top]" type="checkbox" value="1" <?php checked( '1', $options['sociallink_top'] ); ?> />
...
<?php 			_e('&nbsp;<strong>Icon Set :</strong>', 'voyage');
				...
				<p><input id="voyage_theme_options[sociallink_middle]" name="voyage_theme_options[sociallink_middle]" type="checkbox" value="1" <?php checked( '1', $options['sociallink_middle'] ); ?> />
...
<?php 			_e('&nbsp;<strong>Icon Set :</strong>', 'voyage');
				...
				<p><input id="voyage_theme_options[sociallink_bottom]" name="voyage_theme_options[sociallink_bottom]" type="checkbox" value="1" <?php checked( '1', $options['sociallink_bottom'] ); ?> />
...
<?php 			_e('&nbsp;<strong>Icon Set :</strong>', 'voyage');
			...
			<div class="grid_9">
				...
				<label class="description" for="voyage_theme_options[share_bottom]"><?php _e('Bottom', 'voyage'); ?></label>
				</p>
			</div>
			...
			<div class="grid_9">
				...
				<label class="description" for="voyage_theme_options[share_sum_bottom]"><?php _e('Bottom', 'voyage'); ?></label>
				</p>
			</div>
			<div class="clear"></div>
...
<?php
			voyage_option_display( $theme_options['bbp_column1'], $options );
			voyage_option_display( $theme_options['bbp_column2'], $options );
			voyage_option_display( $theme_options['bbp_position'], $options );
...
?>
			...
			<h4><?php _e('The best way of changing fonts is to use child theme or Custom CSS. Learn more about <a href="http://xinthemes.com/how-to-create-voyage-child-theme-and-change-fonts/" target="_blank">How to Create Child Theme and Change Fonts.</a>', 'voyage' ); ?></h4>
<?php 
